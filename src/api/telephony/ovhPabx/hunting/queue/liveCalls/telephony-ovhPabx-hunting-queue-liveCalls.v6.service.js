angular.module('ovh-api-services').service('OvhApiTelephonyOvhPabxHuntingQueueLiveCallsV6', ($resource) => {
  const res = $resource('/telephony/:billingAccount/ovhPabx/:serviceName/hunting/queue/:queueId/liveCalls/:id', {
