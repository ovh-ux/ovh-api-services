angular.module('ovh-api-services').service('OvhApiDbaasLogsAliasV6', ($resource) => {
  // No cache here, because items can be shared at any moment by other users

  const aliasResource = $resource('/dbaas/logs/:serviceName/output/elasticsearch/alias/:aliasId', {
