...
angular.module("ovh-api-services").service("OvhApiCloudProjectInstanceInterface", ["$injector", "$cacheFactory", function ($injector, $cacheFactory) {
...
angular.module("ovh-api-services").service("OvhApiCloudProjectInstanceInterfaceV6", ["$resource", "OvhApiCloudProjectInstanceInterface", function ($resource, OvhApiCloudProjectInstanceInterface) {
...
angular.module("ovh-api-services").service("OvhApiCloudProjectKubeV6", ["$cacheFactory", "$resource", function ($cacheFactory, $resource) {
    "use strict";
...
angular.module("ovh-api-services").service("OvhApiCloudProjectKubeNode", ["$injector", function ($injector) {
    "use strict";
    return {
        v6: function () {
...
angular.module("ovh-api-services").service("OvhApiCloudProjectKubeNodeV6", ["$resource", "$cacheFactory", function ($resource, $cacheFactory) {
    "use strict";
...
angular.module("ovh-api-services").service("OvhApiCloudProjectUserRole", ["$injector", function ($injector) {
...
angular.module("ovh-api-services").service("OvhApiCloudProjectUserRoleV6", ["$resource", "$cacheFactory", function ($resource, $cacheFactory) {
    "use strict";
...
angular.module("ovh-api-services").service("OvhApiDedicatedCloudDatacenterZertoV6", ["$resource", function ($resource) {
    "use strict";
...
angular.module("ovh-api-services").service("OvhApiDedicatedCloudDatacenterZertoSingleV6", ["$resource", function ($resource) {
    "use strict";
...
angular
    ...
    .service("OvhApiDedicatedCloudServicePacks", ["$injector", function ($injector) {
        "use strict";
...
angular
    .module("ovh-api-services")
    .service("OvhApiDedicatedCloudServicePacksV6", ["$resource", "$cacheFactory", function ($resource, $cacheFactory) {
        "use strict";
...
angular
    .module("ovh-api-services")
    .service("OvhApiSupportIceberg", ["iceberg", function (iceberg) {
        "use strict";
